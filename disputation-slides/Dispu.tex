...
\input{text/header-layout}
\input{text/header-colors}
...
\input{text/1-intro} % allgemein, InOrg Dot, Mol Dot, E-Niveaus, etc
...
\input{text/2-dotierung}
\input{text/3-mat}
\input{text/4-theoseebeck}
\input{text/5-setup}
\renewcommand{\secbild}[0]{\includegraphics[width=40mm]{pics/mat-n-white-secbild.pdf}}
\section{Ergebnisse}\input{text/6-erg-n}
\section{Interpretation}\input{text/8-interpretation}
\einzeiler{Zusammenfassung}
\section*{ZF}\input{text/9-concl}
% \input{text/9-dank}
\input{text/9-dank-ohne-Fotos}
