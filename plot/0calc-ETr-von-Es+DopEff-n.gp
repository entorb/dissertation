...
set terminal postscript eps size 14.98cm,14.98cm # wichtig das quadratisch wegen Goldener Schnitt, sonst unten anpassen
...
set output "calc-ETr-von-Es+DopEff" . ".gp" . term
set multiplot
...
plot\
 d u 1:4:3 title "allowed range" with filledcurve above lc rgb "gray60" \
,d u 1:4 t "{/Symbol-Oblique h}_{dop}=100%" ls 1 \
,d u 1:7 t "{/Symbol-Oblique h}_{dop}=30%"  ls 4 \
...
set key t l at screen marL + 0.92*plotX, screen 1.0-marT-1.05*plotY
